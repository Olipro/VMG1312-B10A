...
UNUSUAL_DEV(  0x12d1, 0x1520, 0x0000, 0x0000,
		...
		0),
UNUSUAL_DEV(  0x12d1, 0x1446, 0x0000, 0xFFFF,
		"HUAWEI Mobile",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e1750_init,
		0),
UNUSUAL_DEV(  0x12d1, 0x1c0b, 0x0102, 0x0102,//HUAWEI E173
		"HUAWEI Mobile",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e173_init,
		0),		
UNUSUAL_DEV(  0x12d1, 0x1505, 0x0000, 0xffff,//HUAWEI E372
		"HUAWEI Mobile",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e1750_init,
		0),
UNUSUAL_DEV(  0x19d2, 0x2000, 0x0000, 0xFFFF,
		"ZTE HSDPA Modem",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_mf100_init,
		0),
UNUSUAL_DEV(  0x19d2, 0x0053, 0x0000, 0xFFFF,
		"ZTE HSDPA Modem",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_mf100_init,
		0),
UNUSUAL_DEV(  0x19d2, 0x0101, 0x0000, 0xFFFF,//ZTE K4505-z
		"ZTE HSDPA Modem",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_k4505z_init,
		0),
UNUSUAL_DEV(  0x19d2, 0x0149, 0x0000, 0xFFFF,
        "ZTE HSDPA Modem",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_mf100_init,
        0),
UNUSUAL_DEV(  0x19d2, 0x1001, 0x0000, 0xFFFF,//ZTE K3805-z
		"ZTE HSDPA Modem",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_k4505z_init,
		0),
UNUSUAL_DEV(  0x19d2, 0x1007, 0x0000, 0xFFFF,//ZTE K3570-z
		"ZTE HSDPA Modem",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_k4505z_init,
		0),
...
/*UNUSUAL_DEV(  0x1bbb, 0xf000, 0x0000, 0x0000,
		"ALCATEL",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_alcatel_x220l_init,
		0),*/
#if 0
UNUSUAL_DEV(  0x1c9e, 0xf000, 0x0000, 0xffff,//VKOM 301
		"VKOM Mobile",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_vkom_301_init,
		0),
#endif		
UNUSUAL_DEV(  0x1c9e, 0x98ff, 0x0000, 0xffff,//VKOM 303
		"VKOM Mobile",
		"Mass Storage",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_vkom_301_init,
		0),
#endif //ZyXEL_WWAN_PACKAGE end
#endif
