...
/*This places the HUAWEI E173 devices in multi-port mode*/
int usb_stor_huawei_e173_init(struct us_data *us);
/* This places the VKOM 301USB/303USB device in multi-port mode */
int usb_stor_vkom_301_init(struct us_data *us);
/* This places the ZTE K4505-z device in multi-port mode */
int usb_stor_zte_k4505z_init(struct us_data *us);
/* This places the HUAWEI E1750 devices in multi-port mode */
