...
#if defined(CONFIG_11ac_throughput_patch_from_412L08) && defined(CONFIG_MIPS_BRCM)
...
#if defined(CONFIG_MIPS_BRCM) && defined(CONFIG_SMP) && defined(CONFIG_11ac_throughput_patch_from_412L08)
...
#endif   
#endif
#if 1 // __MSTC__, Delon Yu, move p802.1ag hook function before bcm vlan hook function
#if defined(CONFIG_MIPS_BRCM) && defined(CONFIG_BCM_P8021AG) || defined(CONFIG_BCM_P8021AG_MODULE)
...
#if defined(CONFIG_MIPS_BRCM) && (defined(CONFIG_BCM_VLAN) || defined(CONFIG_BCM_VLAN_MODULE))
#if defined(CONFIG_BCM_TMS_MODULE) && defined(CONFIG_11ac_throughput_patch_from_412L08)
...
#if 0 // __MSTC__, Delon Yu, move p802.1ag hook function before bcm vlan hook function
#if defined(CONFIG_MIPS_BRCM) && defined(CONFIG_BCM_P8021AG) || defined(CONFIG_BCM_P8021AG_MODULE)
	if (((skb->protocol == __constant_htons(ETH_P_8021AG)) || 
		 (skb->protocol == __constant_htons(ETH_P_8021Q) && *(unsigned short *) &skb->data[2] == ETH_P_8021AG))
		 && p8021ag_hook && !p8021ag_hook(skb) )
