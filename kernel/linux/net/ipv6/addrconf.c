...
#if 1 //__MSTC__, Dennis, increase dad_transmits to 7 in order to prevent dad fail while boot up.
...
#if 1 //__MSTC__, Sean Lu, fix the kernel not updates the valid lifeime when receive the valid is less than 2 hr.
					/*
...
#if 1 //__MSTC__, SinJia, Numbered mode and unnumber mode for ipv6 support
static  
int addrconf_sysctl_autoconf(ctl_table *ctl, int write, struct file * filp,  
