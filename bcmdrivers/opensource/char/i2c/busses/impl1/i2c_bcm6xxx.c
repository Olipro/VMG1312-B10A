/* ------------------------------------------------------------------------- */
/* i2c-algo-bcm.c i2c driver algorithms for BCM6816 Embedded I2C adapter     */
/* ------------------------------------------------------------------------- */
...
/* TBD: See if we can use the defines in 6816_map.h */
#define CLK_375K    0
#define CLK_390K    1
...
/* Read the value from given BCM6816 register */
...
/* Write the given value to given BCM6816 register */
...
/*  Keep polling until the BCM6816 completes the I2C transaction or timeout */
...
static int bcm6816_xfer(struct i2c_adapter *adap, 
                        struct i2c_msg *msgs, int num)
{
    ...
    BCM_LOG_DEBUG(BCM_LOG_ID_I2C, "Entering the function %s \n", __FUNCTION__);
    /* The 6816 supports read_then_write and write_then_read formats, 
...
static u32 bcm6816_func(struct i2c_adapter *adap)
{
    BCM_LOG_DEBUG(BCM_LOG_ID_I2C, "Entering the function %s \n", __FUNCTION__);
...
static const struct i2c_algorithm bcm6816_algo = {
    .master_xfer	= bcm6816_xfer,
    .functionality	= bcm6816_func,
};

static struct i2c_adapter bcm6816_i2c_adapter = {
    .owner		= THIS_MODULE,
    .class		= I2C_CLASS_HWMON,
    .algo		= &bcm6816_algo,
    .name		= "BCM6816 I2C driver",
};
...
static int __init bcm6816_i2c_init(void)
{
    ...
    return i2c_add_adapter(&bcm6816_i2c_adapter);
}

static void __exit bcm6816_i2c_exit(void)
{
    i2c_del_adapter(&bcm6816_i2c_adapter);
}

module_init(bcm6816_i2c_init);
module_exit(bcm6816_i2c_exit);

MODULE_AUTHOR("Pratapa Reddy <pratapas@yahoo.com>");
MODULE_DESCRIPTION("I2C-Bus BCM6816 algorithm");
MODULE_LICENSE("GPL");
