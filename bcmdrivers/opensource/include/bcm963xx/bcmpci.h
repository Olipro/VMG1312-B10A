...
/* PCIE memory map in physical address, window1:1MB, window2:16MB or more */
/* forward, chip specific PCIEH_MEMX_XXXX in bcm_map_part.h */
#ifdef PCIEH_MEM1_BASE
#define BCM_PCIE_MEM1_BASE					PCIEH_MEM1_BASE 
#define BCM_PCIE_MEM1_SIZE					PCIEH_MEM1_SIZE
/* old part to clean up, TBD */
...
#endif /*defined __BCM_MAP_PART_H*/
