 ...
 *
 * $Id: wlc_led.c 342036 2012-06-29 18:10:35Z $
 */
...
static void wlc_led_wi8(led_info_t *li, struct led *led);
...
static int wlc_led_watchdog(void *hdl);
...
BCMATTACHFN(wlc_led_attach)(wlc_info_t *wlc)
{
	...
	ledfunc[22] = wlc_led_wi6;
	ledfunc[23] = wlc_led_wi7;
	ledfunc[24] = wlc_led_wi8;
...
/* 1. Led off when not plug or in power save mode */
/* 2. Slow blinking when not connected (before connect to AP) */
/* 3. Off after connect to AP	*/
/* 4. Fast blinking when activity */
static void
wlc_led_wi8(led_info_t *li, struct led *led)
{
