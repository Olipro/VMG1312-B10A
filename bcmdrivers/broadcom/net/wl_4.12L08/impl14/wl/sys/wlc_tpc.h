 ...
 *
 * $Id: wlc_tpc.h 361903 2012-10-10 05:29:09Z $
*/
...
extern void wlc_tpc_rep_build(wlc_info_t *wlc, int8 rssi, ratespec_t rspec,
	dot11_tpc_rep_t *rpt);
extern void wlc_tpc_report(wlc_tpc_info_t *tpc, dot11_tpc_rep_t *rpt);
...
extern void wlc_tpc_set_local_constraint(wlc_tpc_info_t *tpc, dot11_power_cnst_t *pwr);
extern uint8 wlc_tpc_get_local_constraint_qdbm(wlc_tpc_info_t *tpc);

/* IE build/parse */
extern uint8 *wlc_tpc_write_constraint_ie(wlc_tpc_info_t *tpc, wlc_bsscfg_t *cfg,
	uint8 *cp, int buflen);
...
#define wlc_tpc_report(tpc, rpt) do {} while (0)
...
#define wlc_tpc_write_constraint_ie(tpc, cfg, cp, buflen) cp
