 ...
 *
 * $Id: wlconf.c 381138 2013-01-25 08:24:18Z $
 */
...
#ifdef BRCM_SYSCAP_IE
		/* Add BRCM System level Capability IE */
		if (ap || apsta) {
			...
			wlconf_set_brcm_syscap_ie(name, bsscfg->idx, BRCM_PROP_OUI,
				(uchar *)&(brcm_syscap_ie.type), sizeof(brcm_syscap_ie.type)
