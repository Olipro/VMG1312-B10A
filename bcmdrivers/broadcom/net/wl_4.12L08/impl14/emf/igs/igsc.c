 ...
 *
 * $Id: igsc.c 346171 2012-07-20 09:09:40Z $
 */
...
#ifndef IGSC_EXCLUDE_UPNP
	{ 0xeffffffa, 0xffffffff },		/* UPnP */
#endif /* IGSC_EXCLUDE_UPNP */
};
...
#ifdef DSLCPE  
	igsc_sdb_clear_ipv6(IGSC_INFO(snooper));
#endif
...
#ifdef DSLCPE
	igsc_info->wl = osl_pci_get_drvdata(osh_get_pdev(osh));
#endif
...
#ifdef DSLCPE
        if(igsc_init_ipv6(igsc_info, osh)==NULL) return NULL;
#endif
