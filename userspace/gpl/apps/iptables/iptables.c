...
{
	struct hostent *host;
#if 1 // __MSTC__, Richard Huang, Merge from FuChia
	// Don't let Iptables to query host name by address or it will cause system hold for a long time while PPPoE server isn't allowed to access internet.
#else
