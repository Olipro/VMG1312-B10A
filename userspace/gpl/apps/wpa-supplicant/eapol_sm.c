...
#if 1//__MSTC__, Amy, 802.1x for cms
...
extern void send8021XEventMessage(int authStatus, const char *paeState);//__MSTC__, Amy, 802.1x for cms
...
SM_STATE(SUPP_PAE, LOGOFF)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Logoff");//__MSTC__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, DISCONNECTED)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Disconnected");//__MSTC__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, CONNECTING)
{
	...
	if (send_start)
		eapol_sm_txStart(sm);
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Connecting");//__MSTC__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, AUTHENTICATING)
{
	...
	sm->keyDone = FALSE;
	sm->suppStart = TRUE;
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Authenticating");//__MSTC__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, HELD)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Held");//__MSTC__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, AUTHENTICATED)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Authenticated");//__MSTC__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, RESTART)
{
	...
	sm->eapRestart = TRUE;
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "Restart");//__MSTC__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, S_FORCE_AUTH)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "ForceAuth");//__MSTC__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_PAE, S_FORCE_UNAUTH)
{
	...
	eapol_sm_txLogoff(sm);
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "ForceUnauth");//__MSTC__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_BE, SUCCESS)
{
	...
	send8021XEventMessage(WPA_SUPP_STATE_SUCCESS, "");//__MSTC__, Amy, 802.1x for cms
}
...
SM_STATE(SUPP_BE, FAIL)
{
	...
	sm->suppFail = TRUE;
	send8021XEventMessage(WPA_SUPP_STATE_FAIL, "");//__MSTC__, Amy, 802.1x for cms
}
