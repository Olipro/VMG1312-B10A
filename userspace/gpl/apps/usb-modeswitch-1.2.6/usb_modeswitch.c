...
{
#if 1 // defined(ZYXEL_VMG1312) || defined(ZYXEL_VMG5313)	//ZyXEL, Ryan, Fix  HUAWEI 3131 3G dongle cannot work properly
	int ret, ret1;
#else
	int ret;
#endif	
...
#if 1 // defined(ZYXEL_VMG1312) || defined(ZYXEL_VMG5313)	//ZyXEL, Ryan, Fix  HUAWEI 3131 3G dongle cannot work properly
	ret1 = usb_bulk_write(devh, endpoint, message, length, 3000);
#endif	
	if (ret >= 0 ) {
