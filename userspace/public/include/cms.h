...
typedef enum
{
   ...
   CMSRET_INVALID_BOOTROMSIZE = 9857,
	...
	CMSRET_INVALID_WWANPACKAGE = 9858
#endif
#endif
} CmsRet;
...
#define ETH3G_IFC_STR		  "eth3G"  /* CDC_ECM */
#endif
...
{
   INIT=0,
   XDSLATM_UP=1,     /**< This is for httpd login */
   XDSLATM_DOWN=2,        /**< user login */     
   XDSLPTM_UP=3,     /**< support login  */
   XDSLPTM_DOWN=4,      /**< admin login  */     
   ETHERNETWAN_UP=5, 	/**< This is for httpd login */
   ETHERNETWAN_DOWN=6,		/**< user login */	   
   WWAN3G_UP=7, 	/**< support login	*/
   WWAN3G_DOWN=8,		/**< admin login  */   
} WanStutsType;
...
/*__ZyXEL__, Cj_Lai , Add for customer web redirect when romfile parameter <customerWebRedirection></customerWebRedirection> is set IP or URL*/
#define CUSTOMER_WAN_REDIRECT_STATUS_FILE   	"/var/customer_redirect_status"
#endif
#if 1 //ZyXEL, Customization Flag 1
#define UPC_INTERNET_LED_BEHAVIOR			0x00000001 //turn internet green only when default gateway wan interface is up
#define UPC_PPPOE_ALWAYS_RETRY				0x00000002 //always try to reconnect pppoe every 2 minites even authentication is fail
#define DSL_GUI_HIDE_FLAG				0x00000004 //ZyXEL, Albert add for Etisalat, hide DSL 20131118
#define ETHER_WAN_FLAG_GUI				0x00000008 //ZyXEL, Albert add for NZ, config ethWen Port Flag for GUI 20131129
#define ETHER_WAN_SPEED_FLAG_100FD			0x00000010 //ZyXEL, Albert add for NZ, config ethWen Port Speed 20131129
#define ETHER_WAN_SPEED_FLAG_100HD			0x00000020 //ZyXEL, Albert add for NZ, config ethWen Port Speed 20131129
#define ETHER_WAN_SPEED_FLAG_10FD			0x00000040 //ZyXEL, Albert add for NZ, config ethWen Port Speed 20131129
#define ETHER_WAN_SPEED_FLAG_10HD			0x00000080 //ZyXEL, Albert add for NZ, config ethWen Port Speed 20131129
#ifdef FULLRATE_CUSTOMIZATION //cathy add for fullrate customization
#define WIFI_NMODE_TKIP_FLAG				0x00000100 //ZyXEL, Cathy add for support TKIP only on b/g/n mix mode or n mode  
#endif
#define SYSLOG_HIDE_VOIP_FLAG				0x00000200 //ZyXEL, Albert add to control hide VOIP for SYSLOG in GUI 20140122
#define SYSLOG_HIDE_IPSec_FLAG				0x00000400 //ZyXEL, Albert add to control hide IPSec for SYSLOG in GUI 20140218
#define SIP_SHOW_COMPRESS_TYPE_G729			0x00000800 //ZyXEL, Albert add to control SIP compression type G.729 in GUI 20140417
#define ROUTING_CONFIG_DEFAULT_ROUTE_GUI		0x00001000 //ZyXEL, Albert add to control defualt route in GUI 20140507
#define HIDE_GUI_PAGE_1312_TURKEY			0x00002000 //ZyXEL, Ryan add for VMG1312-B10A Turkey
#define WWAN_GUI_HIDE_FLAG				0x00004000 //ZyXEL, Ryan, hide related 3G pages
#define WIFI_AUTO_BANDWIDTH				0x00008000 //ZyXEL, Nick Lu, control WIFI Bandwidth "Auto" show or not
#define HIDE_ZYXEL_CONCURRENT_WAN 0x00010000 //Cathy
#define PRIVILEGE_FROMTR69				0x00020000 //ZyXEL, Wood, add an option to enable/disable PrivilegeData to control Privilege setting.
#define REMOTE_MGMT_FLAG				0x00040000 //ZyXEL, Ricky add  an option to enable/disable trust domain Data to control Remote MGMT setting.
#define HIDE_GUI_PAGE_8924_TIM			0x00080000 //ZyXEL, Albert, hide DOS/traffic(WAN)/USER ACCOUNT(create by user)/status
#define HIDE_GUI_RETRY_TIMER_TIM        0x00100000 //ZyXEL, Brady, modify SIP REGISTER re-transmission.
#define HIDE_GUI_SESSION_TIMER_TIM      0x00200000 //ZyXEL, Brady, disable session refresh function for TIM.
#define ENABLE_GUI_CONN_REUQEST_PORT_TR069      0x00400000 //ZyXEL, Albert, Enable connection request port for TR069
#define ENABLE_GUI_DIAG_PING_INTF      0x00800000 //ZyXEL, Albert, Enable connection request port for TR069
#define ALLOW_MORE_SPECIAL_CHARACTER			0x01000000 //__ZyXEL__, allow to use more special character for VOIP, TR069, DDNS.
#define WEB_REDIRECT_FLAG				0x02000000 //ZyXEL, Ricky add  an option to enable/disable to control Web_redirect setting.
#define TR069_CHECK_LOCAL_CA_CN			0x04000000 //ZyXEL, Albert, Check CN of local CA for TR069 
#define WIFI_INTF_OVERRIDE_MODE2		0x08000000 //ZyXEL, Albert, Interference_override has to be set in mode 2
#define ETHER_LAN4_AS_WAN				0x10000000 //ZyXEL, Albert Lan 4 port as wan for 365 media.
#define ENABLE_UPLOAD_POST_TR069		0x20000000 //ZyXEL, Albert Enable upload configure and log by POST.
#define ENABLE_ZAP_CUSTOMIZATION		0x40000000 //ZyXEL, Albert Enable ZAP customization.
#define ENABLE_USER_ACCOUNT	        	0x80000000 //ZyXEL, Ricky Enable USER ACCOUNT.

//ZyXEL, Customization Flag 2
#define ENABLE_G729_ROM_CONVERT		0x00000001 //ZyXEL, Albert for SIP_SHOW_COMPRESS_TYPE_G729 rom convert
                                               //disalbe = need to rom convert
                                               //enable = already rom convert
