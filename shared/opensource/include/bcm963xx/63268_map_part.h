...
/*
** NAND Interrupt Controller Registers, copied from 6xxxx_map.h
*/
typedef struct NandIntrCtrlRegs_1 {
...
#define NAND_INTR ((volatile NandIntrCtrlRegs_1 * const) NAND_INTR_BASE)
